...
import { login  as axLogin} from '../components/AxiosFunctions.tsx';
import { PulseLoader } from 'react-spinners';
import TextFieldRow from '../components/basic/TextFieldRow.tsx';
...
const Login = () => {
    ...
    const handleLogin = async (_, formData: FormData): Promise<boolean|string> => {
