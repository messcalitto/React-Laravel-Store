...
import { axCartUpdate, ConfirmItemDelete, axCartRemove } from '../AxiosFunctions.tsx';
...
interface CartItemProps {
    ...
    reCalculateTotal: (id: number, quantity: number) => void;
    deleteCurrentItem: (id: number) => void;
}

const CartItem: React.FC<CartItemProps> = ({item, reCalculateTotal, deleteCurrentItem}) => {
